 ...
 * حدُّ الملف الواحد.
 *
 * وسقفُ جسم الطلب عند Cloudflare مئةُ ميغابايت في الخطة المجانية، فخمسون دونه.
 * والأهمُّ أن المرفوع لم يعد يُنسخ في ذاكرة العامل مرتين — انظر `putObject` —
 * وإلا لجاوز ملفٌ من خمسين حدَّ الذاكرة (128م.ب) فسقط الطلب بـ1102.
 */
export const MAX_FILE_BYTES = 50 * 1024 * 1024; // 50 ميغابايت
