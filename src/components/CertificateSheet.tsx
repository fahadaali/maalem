...
export default function CertificateSheet({ name, level, total, serial, issuedAt, note }: { name: string; level: string; total: number; serial: string; issuedAt: Date; note?: string | null }) {
  return (
    <div className="border-4 border-ink rounded-2xl p-10 text-center max-w-3xl mx-auto bg-paper">
      ...
      <h1 className="text-4xl mt-6 mb-1">وثيقة إتمام</h1>
      ...
      <p className="text-base leading-8">
        قد أتمّ متطلبات برنامج «{PROGRAM.name}» لتأهيل المشرفين التربويين الجدد،
        <br />
